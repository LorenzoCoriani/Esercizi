...
class TestRegistroEventi{
	...
	public static void main(String[] args){
		...
		try{
			...
			Evento evento = new Evento("Natale", LocalDate.of(2023, 11, 1), "Descrizione dell'evento 1");
		...
		}catch(CapacitaMassimaException e){
			System.out.println("Errore hai inserito il numero massimo di eventi");
		}
	}
}